...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $input_name = [
        ...
        'group__first'  => 'Фундамент',
        'group__second'  => 'Кровля',

        'dop-1'  => 'Электромонтаж',
        'dop-2'  => 'Водоснабжение и канализация',
        'dop-3'  => 'Отопление и вентиляция',
        'dop-4'  => 'Наружная отделка',
        'dop-5'  => 'Внутренняя черновая отделка',
        'dop-6'  => 'Внутренняя чистовая отделка',
    ];
